...
<html>
	<head>
		...
		<!-- PAGE SPECIFIC -->
		<tilesx:useAttribute id="cssPaths" name="cssPaths" classname="java.util.List" ignore="true" />
		<c:forEach var="cssPath" items="${cssPaths}">
	...
	<body>
	    ...
	    <script src="/washers/resources/plugins/jquery/jquery-2.1.1.min.js"></script>
	    <script src="/washers/resources/theme/js/plugins/bootstrap/bootstrap.min.js"></script>
	     
	    <!-- PAGE SPECIFIC SCRIPTS -->
	    <tilesx:useAttribute id="jsPaths" name="jsPaths" classname="java.util.List" ignore="true" />
